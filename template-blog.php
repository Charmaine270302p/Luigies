                        ...
                        <div class="col-md-7 col-lg-8">
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/blog-1-1000x400.jpg '?>" alt="">
                                        </div>
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/blog-2-1000x400.jpg '?>" alt="">
                                        </div>
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/blog-3-1000x400.jpg '?>" alt="">
                                        </div>
                        ...
                        <div class="col-md-5 col-lg-4">
                                <div class="mx-w-400x mlr-auto">
                                        ...
                                        <div class="mb-50 mb-sm-30 pos-relative oflow-hidden">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/sidebar-1-400x600.jpg '?>" alt="">
                                        ...
                                        <div class="mb-50 mb-sm-30">
                                                ...
                                                <div class="sided-90x mb-30 ">
                                                        <div class="s-left"><img class="br-3" src="<?php echo get_template_directory_uri().'/assets/images/sidebar-3-200x200.jpg '?>" alt="Menu Image"></div>
                                                ...
                                                <div class="sided-90x mb-30 ">
                                                        <div class="s-left"><img class="br-3" src="<?php echo get_template_directory_uri().'/assets/images/sidebar-4-200x200.jpg '?>" alt="Menu Image"></div>
                                                        <div class="s-right left-text">
                                                                <h6 class="color-semi-black">Recipes</h6>
                                                ...
                                                <div class="sided-90x mb-30 ">
                                                        <div class="s-left"><img class="br-3" src="<?php echo get_template_directory_uri().'/assets/images/sidebar-5-200x200.jpg '?>" alt="Menu Image"></div>
                                                        <div class="s-right left-text">
                                                                <h6 class="color-semi-black">Recipes</h6>
                                        ...
                                        <div class="mb-30 pos-relative">
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/sidebar-2-400x600.jpg '?>" alt="">
